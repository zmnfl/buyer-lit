...
```python
TG_TOKEN = "your_telegram_bot_token"       # Telegram bot token
CHAT_ID = "your_telegram_chat_id"          # Telegram chat ID for notifications
...
•	If you do not want to use Telegram notifications, you can leave TG_TOKEN and CHAT_ID empty ("").
